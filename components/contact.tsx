...
import PlanetTagImg01 from "@/public/images/planet-tag/Lanka.png";
...
export default function Contact() {
  return (
    <section id="about">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 mt-16 mb-16">
        <div
        ...
        >
          ...
          <div className="px-4 py-12 md:px-12 md:py-20">
            <h2 className="mb-6 border-y text-3xl font-bold text-gray-200 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-700/.7),transparent)1] md:mb-12 md:text-4xl">
                About Fintec Solutions
            </h2>
            <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
            <p
                className="mb-8 text-md text-gray-100"
                data-aos="zoom-y-out"
                data-aos-delay={300}
              >
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              With strategic alliances across the financial industry,
               We ensure access to the latest trends and developments
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Our dedicated team works closely with you to understand your unique challenges and goals
              </p>
            </article>
